 ...
 */
final class Version20251206190029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD user_id INT NOT NULL, ADD proposal_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE skill CHANGE owner_id owner_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification DROP user_id, DROP proposal_id');
        $this->addSql('ALTER TABLE skill CHANGE owner_id owner_id INT NOT NULL');
    }
}
